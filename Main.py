...
def libranianoptions():
        print("-"*24)
        print("     LIBRANIAN MENU    ")
        print("-"*24)
        print("1. Books")
        print("2. Member")
        print("3. Exit")
...
def libranian():
    ...
    if (admin=="admin101" and password=="project156":
        print()
        print("Logged in as Libranian! ")
        print()
        print()
        libranianoptions()
    else:
        print("Enter admin id or password is wrong! Please Type Again...")
        print()
        libranian()
